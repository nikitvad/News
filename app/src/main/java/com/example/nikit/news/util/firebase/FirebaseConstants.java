...
/**
 * Created by nikit on 26.04.2017.
 */
...
public class FirebaseConstants {
    ...
    public static final String FB_REF_PUBLISHED = "publishedAt";
    public static final String FB_REF_TITLE = "title";
    public static final String FB_REF_URL = "url";
    public static final String FB_REF_URL_TO_IMAGE = "urlToImage";
